...
let captureBtCont = document.querySelector(".capture-btn-cont")
...
captureBtCont.addEventListener("click",(e) => {
    captureBtCont.classList.add("scale-capture");


    let canvas = document.createElement("canvas");
    canvas.width = video.videoWidth;
    canvas.heiight = video.videoHeight;
